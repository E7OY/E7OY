...
🎯 Skills: Habilidades en <trong>Git</strong> para control de versiones. Dominio de React, HTML5, CSS3 y Tailwind para frontend. Experiencia en SQL, Spring, PHP y Java para el desarrollo backend. Familiaridad con Docker, Symfony, BootStrap y otras tecnologías.
